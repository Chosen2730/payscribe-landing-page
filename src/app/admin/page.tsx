    ...
    <AdminShell
      ...
      actions={
        <>
          <Link
            href="/admin/blog/new"
            className="rounded-full bg-secondary px-6 py-3 text-sm font-semibold text-white"
          >
            New post
          </Link>
          <Link
            href="/admin/contact"
            className="rounded-full bg-blue-100 px-6 py-3 text-sm font-semibold text-primary"
          >
            View submissions
          </Link>
        </>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                ...
                {!loading && recentPosts.length === 0 ? <p className="text-sm text-slate-600">No posts yet.</p> : null}
              </div>
            </div>
