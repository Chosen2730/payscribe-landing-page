...
export function GameprideHero() {
	return (
		<section className='relative overflow-hidden bg-[#050505] text-white'>
			...
			<div className='relative z-10 mx-auto max-w-2xl px-5 pb-32 pt-20 text-center md:pb-40 md:pt-28'>
				{/* Logo: gradient ring + inner dark tile with mark */}
				<div className='mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-lime-400 to-yellow-400 p-1 shadow-lg md:h-28 md:w-28'>
